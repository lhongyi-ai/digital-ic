...
def main():
    ...
    out=ROOT/"build"/f"sensor_board_{a.rate}hz{suffix}"
    ...
    script=("read_verilog -defer -sv -DICE40 "+" ".join(sources)+";\n"
            ...
            f"synth_ice40 -dsp -top upduino_sensor -json {out/'netlist.json'};\nstat\n")
...
"""
    ...
    report={"top":"upduino_sensor","rate_hz":a.rate,"total_samples":total,
