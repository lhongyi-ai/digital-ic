...
`endif
    ...
    UUT.pending = 1'b0;
    UUT.saw_abort = 1'b0;
    UUT.in_index = 4'b1110;
    UUT.in_power = 33'b100000000000000000000000000000001;
    UUT.in_shift = 8'b00010100;
    UUT.dut.feature_shifts[4'b0000] = 8'b00000000;
    UUT.dut.feature_shifts[4'b1110] = 8'b00010100;
    UUT.dut.feature_shifts[4'b1111] = 8'b00000000;
    UUT.dut.features[4'b0000] = 8'b00000000;
    UUT.dut.features[4'b1110] = 8'b01111111;
