...
`endif
    ...
    UUT.pending = 1'b0;
    UUT.saw_abort = 1'b0;
    UUT.in_index = 4'b1001;
    UUT.in_power = 33'b000000000000000000010000000000000;
    UUT.in_shift = 8'b00001001;
    UUT.dut.feature_shifts[4'b0000] = 8'b00000000;
    UUT.dut.feature_shifts[4'b1001] = 8'b00001001;
    UUT.dut.feature_shifts[4'b1010] = 8'b00000000;
    UUT.dut.features[4'b0000] = 8'b00000000;
    UUT.dut.features[4'b1001] = 8'b00010000;
