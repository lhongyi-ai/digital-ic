...
`endif
    ...
    UUT.pending = 1'b0;
    UUT.saw_abort = 1'b0;
    UUT.in_index = 4'b0111;
    UUT.in_power = 33'b000000000000000000000000000000001;
    UUT.in_shift = 8'b00011100;
    UUT.dut.feature_shifts[4'b0000] = 8'b00000000;
    UUT.dut.feature_shifts[4'b0111] = 8'b00011100;
    UUT.dut.feature_shifts[4'b1000] = 8'b00000000;
    UUT.dut.features[4'b0000] = 8'b00000000;
    UUT.dut.features[4'b0111] = 8'b00000000;
