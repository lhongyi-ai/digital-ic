...
`endif
    ...
    UUT.pending = 1'b0;
    UUT.saw_abort = 1'b0;
    UUT.in_index = 4'b1101;
    UUT.in_power = 33'b000000000000000000000000000000000;
    UUT.in_shift = 8'b00001100;
    UUT.dut.feature_shifts[4'b0000] = 8'b00000000;
    UUT.dut.feature_shifts[4'b1101] = 8'b00001100;
    UUT.dut.feature_shifts[4'b1110] = 8'b00000000;
    UUT.dut.features[4'b0000] = 8'b00000000;
    UUT.dut.features[4'b1101] = 8'b00000000;
