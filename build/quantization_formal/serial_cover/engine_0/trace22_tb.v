...
`endif
    ...
    UUT.pending = 1'b0;
    UUT.saw_abort = 1'b0;
    UUT.in_index = 4'b0100;
    UUT.in_power = 33'b100000000000000000000000000000000;
    UUT.in_shift = 8'b00001111;
    UUT.dut.feature_shifts[4'b0000] = 8'b00000000;
    UUT.dut.feature_shifts[4'b0100] = 8'b00001111;
    UUT.dut.feature_shifts[4'b0101] = 8'b00001010;
    UUT.dut.features[4'b0000] = 8'b00000000;
    UUT.dut.features[4'b0100] = 8'b01111111;
