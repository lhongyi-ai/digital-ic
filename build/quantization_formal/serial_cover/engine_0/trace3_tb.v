...
`endif
    ...
    UUT.in_power = 33'b000000000000000000000000000001000;
    UUT.in_shift = 8'b00000001;
    UUT.dut.feature_shifts[4'b0000] = 8'b00000000;
    UUT.dut.feature_shifts[4'b0100] = 8'b00000001;
    UUT.dut.feature_shifts[4'b0101] = 8'b00000000;
    UUT.dut.features[4'b0000] = 8'b00000000;
    UUT.dut.features[4'b0100] = 8'b00000100;
