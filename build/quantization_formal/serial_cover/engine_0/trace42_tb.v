...
`endif
    ...
    UUT.pending = 1'b0;
    UUT.saw_abort = 1'b0;
    UUT.in_index = 4'b1010;
    UUT.in_power = 33'b100000000000000000000000000000000;
    UUT.in_shift = 8'b00100001;
    UUT.dut.feature_shifts[4'b0000] = 8'b00000000;
    UUT.dut.feature_shifts[4'b1010] = 8'b00100001;
    UUT.dut.feature_shifts[4'b1011] = 8'b00000000;
    UUT.dut.features[4'b0000] = 8'b00000000;
    UUT.dut.features[4'b1010] = 8'b00000000;
