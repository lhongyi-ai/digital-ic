...
`endif
    ...
    UUT.pending = 1'b0;
    UUT.saw_abort = 1'b0;
    UUT.in_index = 4'b1000;
    UUT.in_power = 33'b000000000000000000100000000000000;
    UUT.in_shift = 8'b00011111;
    UUT.dut.feature_shifts[4'b0000] = 8'b10011110;
    UUT.dut.feature_shifts[4'b1000] = 8'b00011111;
    UUT.dut.feature_shifts[4'b1001] = 8'b00000000;
    UUT.dut.features[4'b0000] = 8'b00000000;
    UUT.dut.features[4'b1000] = 8'b00000000;
